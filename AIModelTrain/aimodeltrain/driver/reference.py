...
train_driver_inst_naive_bayes.train_model(data=training_df, target=target, model_params=model_params, model_hyper_params=model_hyper_params, model_cross_validator_params=model_cross_validator_params)
